...
const replacements = [
  { pattern: /bg-slate-50 dark:bg-slate-900\/50/g, replacement: 'bg-background' },
  { pattern: /bg-slate-50 dark:bg-slate-900/g, replacement: 'bg-background' },
  ...
  { pattern: /bg-slate-200 dark:bg-slate-700\/10/g, replacement: 'bg-muted' },
  ...
  { pattern: /border-slate-200 dark:border-slate-700\/10/g, replacement: 'border-border' },
  { pattern: /border-slate-200 dark:border-slate-700\/30/g, replacement: 'border-border' },
